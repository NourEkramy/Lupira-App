...
class DeleteHistoryConfirmation extends StatelessWidget {
  VoidCallback onDeleteTap;

  DeleteHistoryConfirmation({super.key, required this.onDeleteTap});
